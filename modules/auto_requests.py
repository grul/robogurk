...
def get(url, *args, **kwargs):
    ...
    nr_redirects = 0
    while True:
        response = requests.get(url, *args, **kwargs, timeout=5)
        ...
        return response # do we really need to follow redirects to get a title? REALLY? no. just return
